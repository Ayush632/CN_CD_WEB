...
class Blockchain:
    ...
    def add_block(self, block, proof):
      ...
      #  block.previous_hash=previous_hash
        ...
        print("if previous hash not equals block.hash return false")
       # print(self.block.hash)
       # previous_hash="e57ce5edc0f4c4dfcbdca7efa0fc6a6cd16d94dff8572ab19f84dd28199a9f130"
        ...
        if  not Blockchain.is_valid_proof(block, proof):
            ...
            print("inside is valid proof it returned 0 "+ proof)
            return True

        block.hash = proof
        self.chain.append(block)
        print("appended block to blockchain")
        return True
...
def verify_and_add_block():
    ...
    print("in add block")
    print("contents"+block_data)
    print(type(block_data))
    block_data=eval(block_data)
    print("type after eval")
    print(type(block_data))
 #   print("contents after eval"+block_data)
 ...
 #   print("proof is" )
  ...
  #  block_data['previous_hash']=previous_hash
    added = blockchain.add_block(block, proof)
   # print("Called Add Block it returned"+ added)
    if not added:
...
def announce_new_block(block):
    ...
    respective chains.
    """
    url = "{}/add_block".format(CONNECTED_NODE_ADDRESS1)
